          ...
          <div className="flex max-w-sm flex-col items-center text-center">
            ...
            <div className="relative group inline-block">
              <motion.div
                ...
                className="absolute -inset-1 rounded-[1.25rem] bg-white/20 blur-md pointer-events-none"
              />
              <Link
                href="/onboarding"
                className="relative rounded-[1.125rem] border border-white/10 bg-white/5 px-12 py-5 text-sm font-medium tracking-[0.2em] text-white backdrop-blur-xl transition-all duration-700 hover:bg-white/10 hover:border-white/20 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(255,255,255,0.05)] block"
              >
                {t.hero.ctaPrimary}
